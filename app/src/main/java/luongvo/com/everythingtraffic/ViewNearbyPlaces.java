...
import luongvo.com.everythingtraffic.NearbyPlacesUtil.GetNearbyPlacesData;



public class ViewNearbyPlaces extends FragmentActivity implements LocationListener , OnMapReadyCallback,
...
//                Log.d("onClick", url);
        ...
        Button btnBusStation = (Button) findViewById(R.id.btnBusStation);
...
//                Log.d("onClick", "Button is Clicked");
                ...
                String url = getUrl(latitude, longitude, BusStation);
                Object[] DataTransfer = new Object[2];
                DataTransfer[0] = mMap;
                DataTransfer[1] = url;
//                Log.d("onClick", url);
